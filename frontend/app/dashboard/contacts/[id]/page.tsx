...
export default function ContactDetailPage() {
    ...
    return (
        <div className="space-y-6 sm:space-y-8">
            {/* Back + Header */}
            <div>
                <Link href="/dashboard/contacts" className="inline-flex items-center gap-1.5 text-sm text-muted hover:text-primary active:text-primary transition-all mb-4 px-1 py-1 -ml-1">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 sm:gap-8 items-start">
                ...
                {/* Right Column: Stats & Action (Sticky on Desktop) */}
